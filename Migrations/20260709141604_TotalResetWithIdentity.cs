        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultLogoId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobLatitude = table.Column<double>(type: "float", nullable: true),
                    JobLongitude = table.Column<double>(type: "float", nullable: true),
                    IsOnSite = table.Column<bool>(type: "bit", nullable: false),
                    IsHomeOffice = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    IsMinijob = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    SalaryUnit = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_CompanyProfileId",
                table: "JobPostings",
